            ...
            <Row className='g-2'>
                <Col xs={12} sm={6} md={4} lg={3}>
                    <a href='https://www.framer.com/ai/' target='_blank' rel='noopener noreferrer'>
                        <Card className='cardSelectedLink'>
                            <Row>
                                <h5 className="titleLink "> <img src="src/assets/design/framerIA.png" alt="Framer Logo" className="linkIcon" /> Framer IA</h5>
                            </Row>
                ...
                <Col xs={12} sm={6} md={4} lg={3}>
                    <a href='https://www.happyhues.co/' target='_blank' rel='noopener noreferrer'>
                        <Card className='cardSelectedLink'>
                            <h5 className='titleLink'> <img src="src/assets/design/happyHues.png" alt="Framer Logo" className="linkIcon" /> Happy Hues</h5>
                ...
                <Col xs={12} sm={6} md={4} lg={3}>
                    <a href='https://quickfavs.com/' target='_blank' rel='noopener noreferrer'>
                        <Card className='cardSelectedLink'>
                            <h5 className='titleLink'> <img src="src/assets/design/quickFavs.png" alt="Framer Logo" className="linkIcon" /> QuickFavs</h5>
